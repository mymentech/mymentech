	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'mymentech' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'mymentech' ); ?></th>
			</tr>
		</thead>
		<tbody>
